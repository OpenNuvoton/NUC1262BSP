...
const LED_LLSI_IO_SETTING LED_LLSI_IO_Setting[TOTAL_LED_AREA] =
    {{PB, 15, BIT15, GPAB_IRQn,  0x3C /* SYS->GPB_MFPH */, 0x7C, SYS_GPB_MFPH_PB15MFP_Msk, SYS_GPB_MFPH_PB15MFP_LLSI0_OUT},
     ...
     {PB, 3,  BIT3,  GPAB_IRQn,  0x38 /* SYS->GPB_MFPL */, 0x4C, SYS_GPB_MFPL_PB3MFP_Msk,  SYS_GPB_MFPL_PB3MFP_LLSI6_OUT},
     {PB, 2,  BIT2,  GPAB_IRQn,  0x38 /* SYS->GPB_MFPL */, 0x48, SYS_GPB_MFPL_PB2MFP_Msk,  SYS_GPB_MFPL_PB2MFP_LLSI7_OUT},
     {PC, 1,  BIT1,  GPCDF_IRQn, 0x40 /* SYS->GPC_MFPL */, 0x84, SYS_GPC_MFPL_PC1MFP_Msk,  SYS_GPC_MFPL_PC1MFP_LLSI8_OUT},
     {PC, 0,  BIT0,  GPCDF_IRQn, 0x40 /* SYS->GPC_MFPL */, 0x80, SYS_GPC_MFPL_PC0MFP_Msk,  SYS_GPC_MFPL_PC0MFP_LLSI9_OUT}};
