 ...
 * @file     SDCARD.h
 * @version  V3.00
 * @brief    NUC1262 series SD Card header file
 *
 * @note
...
/** @addtogroup NUC1262_Library NUC1262 Library
  @{
*/

/** @addtogroup NUC1262_SDCARD SDCARD Library
  @{
*/

/** @addtogroup NUC1262_SDCARD_EXPORTED_CONSTANTS SDCARD Library Exported Constants
  @{
*/
...
/*@}*/ /* end of group NUC1262_SDCARD_EXPORTED_CONSTANTS */

/** @addtogroup NUC1262_SDCARD_EXPORTED_STRUCTS SDCARD Library Exported Structs
  @{
*/
...
/*@}*/ /* end of group NUC1262_SDCARD_EXPORTED_STRUCTS */

/** @addtogroup NUC1262_SDCARD_EXPORTED_FUNCTIONS SDCARD Library Exported Functions
  @{
*/
...
/*@}*/ /* end of group NUC1262_SDCARD_EXPORTED_FUNCTIONS */


/*@}*/ /* end of group NUC1262_SDCARD */

/*@}*/ /* end of group NUC1262_Library */
