 ...
 * @file     massstorage.h
 * @version  V3.00
 * @brief    NUC1262 series USBD mass storage header file
 *
 * @note
...
/******************************************************************************/
/** @addtogroup NUC1262_USBD_Mass_Exported_Struct NUC1262 USBD Mass Exported Struct
  NUC1262 USBD Mass Specific Struct
  @{
*/
